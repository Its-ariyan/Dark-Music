...
async def on_clone(self, message):
    ...
    if not str(message.forward_from.id) != "93372553":
        ...
        try:
            ...
            await msg.edit_text(f"Your Bot Has Been Successfully Started :- @{bot.username} Now Add Your Bot And Assistant @Cloner_Assistant To Your Chat! Thanks for Cloning.")
